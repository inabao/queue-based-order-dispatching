...
public class Order implements SavableObject, ZoneObj {
    ...
    public Order fromString(String recordString){
        ...
        order.startTime = Double.valueOf(result[7]).longValue();
        order.endTime = Double.valueOf(result[8]).longValue();
    ...
    public double getDistance(Driver driver) {
        return Point.distance(driver.getCurPos(), startPoint==null?fakePoint:startPoint);
    }
